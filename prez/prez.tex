...
%\frametitle{Radovi}
%\begin{itemize}
%	\item Labutov, 2015., Duboka pitanja bez dubokog razumijevanja
%	\item Flor, 2018., Pristup automatskom generiranju domenski neovisnih pitanja temeljen na semantičkim ulogama
%	\item Du, 2018., Prikupljanje parova pitanja i odgovora temeljenih na odlomcima s Wikipedije
%\end{itemize}
%\end{frame}
...
Nedostaci
\begin{itemize}
	\item nepoznavanje odgovora
	\item temeljenje upita na jednoj rečenici
	\item jedno pitanje iz jedne rečenice
\end{itemize}

Prednosti
\begin{itemize}
	\item zanimljiv pristup, primjenjiv na druga područja
	\item lakša izmjenjivost zbog neovisnosti o treniranju
	\item ljudski neovisne metrike
\end{itemize}
\end{frame}
