...
\chapter{Zaključak}
Iako zbog nedostatka točnih odgovora nepotpuno prikladan za korištenje u evaluaciji studenata, pristup u \cite{labutov2015deep} predstavlja inovativan i zanimljiv radni okvir za druge jezične primjene, kao npr.\ sažimanje \engl{summarization}. Prostor za napredak leži u korištenju kompleksnijih značajki, kao i klasifikacijskog modela kompleksnijeg od logističke regresije. Pristup Iako nov, rad \cite{flor2018semantic} predstavlja stariji pristup temeljen na pravilima, koji svejedno ne zaostaje za dubokim pristupom. Međutim oblikovanje pravila iziskuje jezičnu vještinu veću od prosjeka. Duboki model u \cite{du2018harvesting} dio je suvremenog trenda u obradi prirodnog jezika. Evaluacija je u ovom području otežana jer se može oslanjati na ljudski posao procjene kvalitete izlaza sustava.
